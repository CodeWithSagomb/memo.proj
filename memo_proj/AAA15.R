...
persp(ages,years, mx,theta = 40, phi = 10,col = 8,ltheta = 100) 

persp3d(ages,1977:2019, mx,theta = 40, phi = 10, col = "#ff8080",ltheta = 50)
...
data.kt<-data.frame(year.t=1977:2019,kt=new_k)
...
persp3d(0:119,2020:2049, ln_mxt_forecasted,theta = 40, phi = 10, col = 2:5,ltheta = 50)
...
tab_esp<-probs2lifetable(qx_forcasted[,31] ,radix = 100000,type = "qx")
tab_esp
A<-tabbx(qx_forcasted[,31])
A
